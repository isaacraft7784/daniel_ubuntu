...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('INAOE template/css/sb-admin-2.min.css') }}">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user">
                                        ...
                                        <a href="{{ url('/principal') }}" class="btn btn-primary btn-user btn-block">
                                            Login
                                        </a>
                                        <hr>
                                    </form>
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="{{ url('/principal') }}">No perteneces al LIEE?</a>
                                    </div>
                                </div>
                            </div>
                        </div>
